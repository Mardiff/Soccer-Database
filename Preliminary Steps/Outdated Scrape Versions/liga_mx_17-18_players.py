...
url = 'https://www.transfermarkt.co.uk/liga-mx-apertura/startseite/wettbewerb/MEXA'
...
for team in teams:
	...
	team_pd_url = 'https://www.transfermarkt.co.uk/atlanta-united-fc/leistungsdaten/verein/' + str(team_id) + '/plus/0?reldata=MEXA%262017'
