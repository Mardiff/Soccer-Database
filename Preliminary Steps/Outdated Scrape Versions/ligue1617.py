...
url = 'https://www.transfermarkt.com/1-bundesliga/startseite/wettbewerb/FR1/plus/?saison_id=2016'
...
for ftable in ftables:
	...
	for frow in frows:
		...
		if game_id == '2702772':
			hmanager = 'Frédéric Hantz'
			amanager = 'Pablo Correa'
			home_lineup.append('5686')
			home_lineup.append('22386')
			home_lineup.append('127128')
			home_lineup.append('4811')
			home_lineup.append('127076')
			home_lineup.append('77826')
			home_lineup.append('93726')
			home_lineup.append('174094')
			home_lineup.append('37157')
			home_lineup.append('290587')
			home_lineup.append('238639')
			away_lineup.append('53306')
			away_lineup.append('109720')
			away_lineup.append('256902')
			away_lineup.append('182904')
			away_lineup.append('205497')
			away_lineup.append('1327')
			away_lineup.append('265569')
			away_lineup.append('263294')
			away_lineup.append('39924')
			away_lineup.append('205519')
			away_lineup.append('23952')
		elif game_id == '2735503':
			hmanager = 'Patrick Collot'
			amanager = 'Bernard Casoni'
			home_lineup.append('182906')
			home_lineup.append('17179')
			home_lineup.append('12096')
			home_lineup.append('102744')
			home_lineup.append('126673')
			home_lineup.append('205503')
			home_lineup.append('290256')
			home_lineup.append('187847')
			home_lineup.append('183720')
			home_lineup.append('184491')
			home_lineup.append('122116')
			away_lineup.append('127181')
			away_lineup.append('203517')
			away_lineup.append('75282')
			away_lineup.append('111026')
			away_lineup.append('120651')
			away_lineup.append('20622')
			away_lineup.append('168536')
			away_lineup.append('39909')
			away_lineup.append('255220')
			away_lineup.append('146805')
			away_lineup.append('3266')
		elif game_id == '2735515':
			hmanager = 'Bruno Génésio'
			amanager = 'Pablo Correa'
			home_lineup.append('60561')
			home_lineup.append('28335')
			home_lineup.append('57480')
			home_lineup.append('275512')
			home_lineup.append('23960')
			home_lineup.append('60542')
			home_lineup.append('353948')
			home_lineup.append('234781')
			home_lineup.append('203496')
			home_lineup.append('40687')
			home_lineup.append('93720')
			away_lineup.append('129561')
			away_lineup.append('205497')
			away_lineup.append('77348')
			away_lineup.append('109720')
			away_lineup.append('256902')
			away_lineup.append('357072')
			away_lineup.append('265569')
			away_lineup.append('1327')
			away_lineup.append('66791')
			away_lineup.append('75645')
			away_lineup.append('5345')
		elif game_id == '2735602':
			hmanager = 'Lucien Favre'
			amanager = 'Pablo Correa'
			home_lineup.append('241231')
			home_lineup.append('111058')
			home_lineup.append('60558')
			home_lineup.append('16136')
			home_lineup.append('312862')
			home_lineup.append('290551')
			home_lineup.append('178614')
			home_lineup.append('215876')
			home_lineup.append('118022')
			home_lineup.append('126687')
			home_lineup.append('139018')
			away_lineup.append('53306')
			away_lineup.append('302991')
			away_lineup.append('77348')
			away_lineup.append('16353')
			away_lineup.append('109720')
			away_lineup.append('265569')
			away_lineup.append('66791')
			away_lineup.append('5406')
			away_lineup.append('75645')
			away_lineup.append('43942')
			away_lineup.append('170916')
		else:
