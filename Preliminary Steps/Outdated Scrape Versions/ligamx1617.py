...
url = 'https://www.transfermarkt.com/liga-mx-apertura/startseite/wettbewerb/MEXA/plus/?saison_id=2017'
...
for ftable in ftables:
	...
	for frow in frows:
		...
		if game_id == '2894353':
			hmanager = 'Antonio Mohamed'
			amanager = 'Juan Luna'
			home_lineup.append('129031')
			home_lineup.append('55997')
			home_lineup.append('70833')
			home_lineup.append('131093')
			home_lineup.append('58911')
			home_lineup.append('148713')
			home_lineup.append('135082')
			home_lineup.append('74667')
			home_lineup.append('125250')
			home_lineup.append('74373')
			home_lineup.append('332764')
			away_lineup.append('95172')
			away_lineup.append('68932')
			away_lineup.append('53562')
			away_lineup.append('68868')
			away_lineup.append('67668')
			away_lineup.append('248246')
			away_lineup.append('53177')
			away_lineup.append('44921')
			away_lineup.append('131113')
			away_lineup.append('74086')
			away_lineup.append('85371')
		elif game_id == '2904443':
			hmanager = 'Juan Luna'
			amanager = 'Jaime Lozano'
			home_lineup.append('95172')
			home_lineup.append('68868')
			home_lineup.append('185247')
			home_lineup.append('53035')
			home_lineup.append('129314')
			home_lineup.append('44921')
			home_lineup.append('55941')
			home_lineup.append('53064')
			home_lineup.append('131113')
			home_lineup.append('74086')
			home_lineup.append('85371')
			away_lineup.append('227671')
			away_lineup.append('244724')
			away_lineup.append('107136')
			away_lineup.append('76157')
			away_lineup.append('39454')
			away_lineup.append('500994')
			away_lineup.append('164749')
			away_lineup.append('55386')
			away_lineup.append('158333')
			away_lineup.append('90147')
			away_lineup.append('205041')
		elif game_id == '2904475':
			hmanager = 'Antonio Mohamed'
			amanager = 'José Guadalupe Cruz'
			home_lineup.append('129031')
			home_lineup.append('66130')
			home_lineup.append('387687')
			home_lineup.append('55997')
			home_lineup.append('55895')
			home_lineup.append('125250')
			home_lineup.append('332764')
			home_lineup.append('74373')
			home_lineup.append('74667')
			home_lineup.append('148713')
			home_lineup.append('135082')
			away_lineup.append('54839')
			away_lineup.append('419457')
			away_lineup.append('39408')
			away_lineup.append('162947')
			away_lineup.append('264133')
			away_lineup.append('228255')
			away_lineup.append('234227')
			away_lineup.append('64843')
			away_lineup.append('55156')
			away_lineup.append('401311')
			away_lineup.append('273909')
		else:
