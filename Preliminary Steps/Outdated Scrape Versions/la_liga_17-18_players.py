...
url = 'https://www.transfermarkt.co.uk/1-bundesliga/startseite/wettbewerb/ES1'
...
for team in teams:
	...
	team_pd_url = 'https://www.transfermarkt.co.uk/atlanta-united-fc/leistungsdaten/verein/' + str(team_id) + '/plus/0?reldata=ES1%262017'
