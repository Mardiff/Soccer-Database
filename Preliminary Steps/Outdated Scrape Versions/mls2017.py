...
url = 'https://www.transfermarkt.co.uk/major-league-soccer/startseite/wettbewerb/MLS1/plus/?saison_id=2016'
headers = {"User-Agent":"Mozilla/5.0"}
response = requests.get(url, headers=headers)
soup = bs4.BeautifulSoup(response.text, 'lxml')

filename = "mls_database.csv"
...
teams = soup.findAll('div', {'class' : 'tab-print'})[0].tbody.findAll('tr') + soup.findAll('div', {'class' : 'tab-print'})[1].tbody.findAll('tr')
...
for team in teams:
	...
	team_url = 'https://www.transfermarkt.co.uk' + team.findAll('td')[1].a['href']
	team_points = team.findAll('td')[5].getText()
	team_pd_url = 'https://www.transfermarkt.co.uk/atlanta-united-fc/leistungsdaten/verein/' + str(team_id) + '/plus/0?reldata=MLS1%262016'
...
for ftable in ftables:
	...
	for frow in frows:
		...
		if(game_id != '2820059' and game_id != '2824699'):
		...
		elif game_id == '2820059':
			hmanager = 'Pablo Mastroeni'
			amanager = 'Gregg Berhalter'
			home_lineup.append('156300')
			home_lineup.append('306401')
			home_lineup.append('249624')
			home_lineup.append('480719')
			home_lineup.append('245315')
			home_lineup.append('32704')
			home_lineup.append('125698')
			home_lineup.append('228498')
			home_lineup.append('211085')
			home_lineup.append('354840')
			home_lineup.append('35193')
			away_lineup.append('221624')
			away_lineup.append('65830')
			away_lineup.append('478530')
			away_lineup.append('211587')
			away_lineup.append('222275')
			away_lineup.append('163492')
			away_lineup.append('164478')
			away_lineup.append('45612')
			away_lineup.append('199559')
			away_lineup.append('62067')
			away_lineup.append('175387')
