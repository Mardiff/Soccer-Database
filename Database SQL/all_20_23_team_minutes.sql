SELECT AllAll.name as 'Team', U2023.U20_Domestic as 'U20 Domestic', U2023.U20_Percentage as 'U20 Domestic Percentage', U2023.U23_Domestic as 'U23 Domestic', U2023.U23_Percentage as 'U23 Domestic Percentage', AllAll.Domestic as 'Domestic', AllAll.Percentage as 'Domestic Percentage', AllAll.Total
FROM
(SELECT U20.name, U20.Domestic as 'U20_Domestic', U20.Percentage as 'U20_Percentage', U23.Domestic as 'U23_Domestic', U23.Percentage as 'U23_Percentage', U20.Total
FROM
...
AND (('United States' = Player.nat1 OR 'United States' = Player.nat2) AND Player.birthdate >= '1998-01-01') AND Team.league = League.id
...
AND ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1998-01-01')
AND (NOT ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1998-01-01'))
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1998-01-01')) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1998-01-01'))
AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1998-01-01')))
...
WHERE Game.home = Team.id
AND Game.home1 = Player.id
AND (('United States' = Player.nat1 OR 'United States' = Player.nat2) AND Player.birthdate >= '1995-01-01') AND Team.league = League.id
GROUP BY Team.id) as h1
ON Team.id = h1.id) as h1
LEFT JOIN
(SELECT Team.id, COUNT(*) as usstarts
...
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1995-01-01')
AND (NOT ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1995-01-01'))
GROUP BY Team.id) as subin_minutes
ON start_minutes.id = subin_minutes.id) as startin_minutes
LEFT JOIN
(SELECT Team.id, SUM(90-Event.minute) as minutes
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1995-01-01')) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1995-01-01'))
AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1995-01-01')))
GROUP BY Team.id) as subout_minutes
ON startin_minutes.id = subout_minutes.id) as all_domestic_minutes
ON all_minutes.id = all_domestic_minutes.id) as dirty
WHERE Team.id = dirty.id) as U23
ON U20.name = U23.name) as U2023
LEFT JOIN
(SELECT Team.name, IFNULL(dirty.Domestic,0) as Domestic, IFNULL(dirty.Total,0) as Total, IFNULL(dirty.Percentage,0) as Percentage
FROM Team,
(SELECT all_minutes.id, all_domestic_minutes.minutes as Domestic, all_minutes.minutes as Total, IFNULL(((all_domestic_minutes.minutes/all_minutes.minutes) * 100),0) as Percentage
...
WHERE Game.home = Team.id
AND Game.home1 = Player.id
AND (('United States' = Player.nat1 OR 'United States' = Player.nat2) ) AND Team.league = League.id
GROUP BY Team.id) as h1
ON Team.id = h1.id) as h1
LEFT JOIN
(SELECT Team.id, COUNT(*) as usstarts
...
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') )
AND (NOT ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') ))
GROUP BY Team.id) as subin_minutes
ON start_minutes.id = subin_minutes.id) as startin_minutes
LEFT JOIN
(SELECT Team.id, SUM(90-Event.minute) as minutes
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') )) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') ))
AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') )))
GROUP BY Team.id) as subout_minutes
ON startin_minutes.id = subout_minutes.id) as all_domestic_minutes
ON all_minutes.id = all_domestic_minutes.id) as dirty
WHERE Team.id = dirty.id) as AllAll
ON U2023.name = AllAll.name
ORDER BY AllAll.Domestic DESC