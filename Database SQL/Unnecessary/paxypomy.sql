...
AND (Player.name = 'Paxton Pomykal') AND Team.league = League.id
...
AND (Player2.name = 'Paxton Pomykal')
AND (NOT (Player1.name = 'Paxton Pomykal'))
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND (Player1.name = 'Paxton Pomykal')) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT (Player2.name = 'Paxton Pomykal'))
AND (Player1.name = 'Paxton Pomykal')))
