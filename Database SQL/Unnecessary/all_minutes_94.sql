...
AND ( Player.birthdate >= '1994-01-01') AND Team.league = League.id
...
AND (Player2.birthdate >= '1994-01-01')
AND (NOT (Player1.birthdate >= '1994-01-01'))
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND (Player1.birthdate >= '1994-01-01')) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT (Player2.birthdate >= '1994-01-01'))
AND (Player1.birthdate >= '1994-01-01')))
