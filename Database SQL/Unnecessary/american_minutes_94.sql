...
AND (('United States' = Player.nat1 OR 'United States' = Player.nat2) AND Player.birthdate >= '1994-01-01') AND Team.league = League.id
...
AND ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1994-01-01')
AND (NOT ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1994-01-01'))
...
WHERE Event.team = Team.id
AND Team.league = League.id
AND (((Event.type = 'red' OR Event.type = 'yellowred') AND Event.player1 = Player1.id AND Player1.id = Player2.id AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1994-01-01')) 
OR (Event.type = 'sub'
AND Event.player1 = Player1.id
AND Event.player2 = Player2.id
AND (NOT ((Player2.nat1 = 'United States' OR Player2.nat2 = 'United States') AND Player2.birthdate >= '1994-01-01'))
AND ((Player1.nat1 = 'United States' OR Player1.nat2 = 'United States') AND Player1.birthdate >= '1994-01-01')))
