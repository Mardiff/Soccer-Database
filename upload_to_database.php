...
$conn = mysqli_connect("localhost", "root", "washington", "MLS_2018");	
...
for($x = 0; $x < count($files); $x++) {
	...
	while($line=fgets($fhandle)) {
		...
		printf("Entering entry %s out of %s, %d%% \n", $count, 6000, 100*($count/6000/count($files) + $x/count($files)));
...
function getEventIDStart($filename) {
